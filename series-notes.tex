...
\begin{document}
  ...
  \paragraph{Theorem: The ratio test}
  If $\rho = \lim_{n\to\infty}|\frac{a_{n+1}}{a_n}|$ exists or is infinite,
  then $\sum a_n$ of nonzero terms converge absolutely if $\rho < 1$ and
  diverges if $p > 1$. If $\rho = 1$, the test is inconclusive.
